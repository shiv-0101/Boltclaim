                ...
                <div class="col-md-4">
                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="role" id="roleUser"
                                                    value="USER" checked onchange="toggleAdminKey()">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="role" id="roleAdmin"
                                                    value="ADMIN" onchange="toggleAdminKey()">
                                                <label class="form-check-label text-white" for="roleAdmin">Admin</label>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mb-4" id="adminKeyDiv" style="display: none;">
                                        <label class="form-label small text-secondary">Admin Registration Key</label>
                                        <input type="password" name="adminKey" class="form-control"
                                            placeholder="Enter key provided by superuser">
                                    </div>
                    ...
                    <p class="text-center mt-4">
                        <a href="${pageContext.request.contextPath}/"
                            class="text-secondary small text-decoration-none">← Back to home</a>
                    </p>
                </div>
            </div>
        </div>
